...
import { createMySQLDriver } from '../../src/driver/mysql.js';
import type { Driver } from '../../src/driver/types.js';

describe.skipIf(!process.env.MYSQL_URL)('MySQL Driver Integration', () => {
  let driver: Driver;
  const testTableName = 'test_integration_users';

  beforeAll(async () => {
    driver = await createMySQLDriver({
...
describe.skipIf(!process.env.MYSQL_URL)('DbClient MySQL Integration', () => {
  let driver: Driver;
  let client: DbClient;
