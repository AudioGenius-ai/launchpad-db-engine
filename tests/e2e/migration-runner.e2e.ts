...
describe.skipIf(!DATABASE_URL)('MigrationRunner E2E Tests', () => {
  ...
  describe('Migration Table Creation', () => {
    it(
      'should create migrations tracking table on first run',
      async () => {
    ...
    it(
      'should be idempotent - running multiple times does not error',
      async () => {
        const runner = createMigrationRunner(driver, {
          migrationsPath: tempDir,
          tableName: testTableName,
  ...
  describe('Running Migrations (up)', () => {
    it(
      'should run a single migration from file',
      async () => {
...
DROP TABLE "${tableName}";`
    ...
    it(
      'should run multiple migrations in version order',
      async () => {
...
DROP TABLE "${accountsTable}";`
    ...
    it(
      'should respect toVersion option',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
        const accountsTable = `e2e_accounts_${testTableName}`;
...
DROP TABLE "${usersTable}";`
    ...
    it(
      'should stop on failed migration',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE never_created;`
  ...
  describe('Rolling Back Migrations (down)', () => {
    it(
      'should rollback a single migration',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${accountsTable}";`
    ...
    it(
      'should respect steps option for rollback',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
        const accountsTable = `e2e_accounts_${testTableName}`;
...
DROP TABLE "${accountsTable}";`
    ...
    it(
      'should fail gracefully when no down migration exists',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
CREATE TABLE "${usersTable}" (id UUID PRIMARY KEY);`
  ...
  describe('Migration State Tracking', () => {
    it(
      'should record applied migrations with metadata',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${usersTable}";`
    ...
    it(
      'should store up and down SQL in migration record',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${usersTable}";`
    ...
    it(
      'should remove migration record on rollback',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${usersTable}";`
  ...
  describe('Migration Status', () => {
    it(
      'should report pending migrations',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${usersTable}";`
    ...
    it(
      'should report mixed state correctly',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
        const accountsTable = `e2e_accounts_${testTableName}`;
...
DROP TABLE "${accountsTable}";`
  ...
  describe('Migration Verification', () => {
    it(
      'should verify migrations with matching checksums',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${usersTable}";`
    ...
    it(
      'should detect modified migration files',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${usersTable}";`
  ...
  describe('Dry Run Mode', () => {
    it(
      'should not apply migrations in dry run mode',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${usersTable}";`
    ...
    it(
      'should not rollback migrations in dry run mode',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${usersTable}";`
  ...
  describe('Transaction Safety', () => {
    it(
      'should rollback failed migration atomically',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${usersTable}";`
  ...
  describe('Template Migrations', () => {
    it(
      'should run template-specific migrations',
      async () => {
...
DROP TABLE "${templateTable}";`
    ...
    it(
      'should isolate template migrations from core',
      async () => {
...
DROP TABLE "${templateTable}";`
  ...
  describe('Edge Cases', () => {
    ...
    it(
      'should handle non-existent migrations directory gracefully',
      async () => {
        const runner = createMigrationRunner(driver, {
    ...
    it(
      'should ignore non-SQL files in migrations directory',
      async () => {
    ...
    it(
      'should handle migration with multiple statements correctly',
      async () => {
        const usersTable = `e2e_users_${testTableName}`;
...
DROP TABLE "${usersTable}";`
        ...
        const data = await driver.query<{ name: string }>(`SELECT name FROM "${usersTable}"`);
